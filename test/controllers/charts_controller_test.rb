...
class ChartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chart" do
    assert_difference('Chart.count') do
      post charts_url, params: { chart: { date_attendance: @chart.date_attendance, pet_id: @chart.pet_id, symptoms: @chart.symptoms, treatment: @chart.treatment } }
    end
  ...
  test "should update chart" do
    patch chart_url(@chart), params: { chart: { date_attendance: @chart.date_attendance, pet_id: @chart.pet_id, symptoms: @chart.symptoms, treatment: @chart.treatment } }
